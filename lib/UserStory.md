...
I want to check my caps and punctuation
I want to check how much of my work is correct, as a %
...
check("This is the sentence to check over")
check: true or false
...
```ruby
check("This is the sentence to check over") => false
check("This is the sentence to check over.") => true
